...
export const CHILLI_VARIETIES: ChilliVariety[] = [
  {
    ...
    image: v2282,
    shortDescription: 'A dependable high-yielding option with strong plant vigor, attractive long fruits, and excellent field performance for progressive chilli growers.',
    highlights: ['Strong plant vigor', 'Long, uniform fruits', 'Healthy green-to-red maturity', 'Farmer-friendly performance'],
  },
  {
    id: '1191',
    name: 'HY-1191',
    category: 'Chilli Variety',
    image: v1191,
    shortDescription: 'HY-1191 stands out for its robust crop habit, strong fruit setting, and reliable productivity in well-managed nursery and field conditions.',
    highlights: ['Strong fruit setting', 'Uniform fruit appearance', 'Reliable field performance', 'Good nursery-to-field transition'],
  },
  {
    id: '2433',
    name: '2433',
    category: 'Chilli Variety',
    image: v2433,
    shortDescription: '2433 is a promising choice for farmers seeking dense crop coverage, healthy canopy growth, and long fruit development with strong market appeal.',
    highlights: ['Dense crop coverage', 'Healthy canopy growth', 'Long green-to-red chilli fruits', 'Strong farmer demand potential'],
  },
  {
    id: '1298',
    name: '1298',
    category: 'Chilli Variety',
    image: v1298,
    shortDescription: '1298 delivers a bold field presence with vigorous fruiting, attractive red maturity, and excellent productivity for seasonal chilli cultivation.',
    highlights: ['Heavy fruit set', 'Vigorous field growth', 'Bright red maturity', 'High productivity outlook'],
  },
  {
    id: '0728',
    name: '0728',
    category: 'Chilli Variety',
    image: v0728,
    shortDescription: '0728 is valued for its dependable growth, healthy transplanting performance, and attractive chilli fruit output that supports strong farmer returns.',
    highlights: ['Healthy transplants', 'Dependable growth habit', 'Attractive fruit output', 'Farmer-trusted performance'],
  },
];
