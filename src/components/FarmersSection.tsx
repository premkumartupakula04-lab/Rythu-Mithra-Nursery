      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-3 text-base sm:text-lg text-stone-600">
            Real agricultural photographs of farmers across Andhra Pradesh and Telangana cultivating chillies with seedlings from Rythu Mithra Nursery.
          </p>
        </div>

        {/* Dedicated 10-Image Grid: Desktop 5x2, Tablet 3-4 col, Mobile 2 col */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-5">
          {FARMERS_LIST.map((farmer, idx) => (
            ...
            >
              ...
              <div className="aspect-[4/5] sm:aspect-[3/4] overflow-hidden bg-stone-200">
                <img
                  src={farmer.image}
                  alt={farmer.alt}
