            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              >
                <img
                  ...
                  className="w-full h-96 sm:h-[430px] object-contain transition-opacity duration-300"
                  loading="lazy"
                />
              ...
              >
                <img
                  ...
                  className="w-full h-32 sm:h-36 object-contain transition-opacity duration-300"
                  loading="lazy"
                />
